...
;; Stolen from <https://github.com/Axlefublr/dotfiles/blob/985c5ad31b4fdbe94ad3ecc55fd459f09ed7a40b/!nvim/queries/lua/injections.scm>
((function_call
  name: [
...
((function_call
	...
	arguments: (arguments
		...
		(string
		  content: _ @injection.content)))
 (#set! injection.language "vim")
 (#eq? @_vimcmd_identifier "env.acmd"))
